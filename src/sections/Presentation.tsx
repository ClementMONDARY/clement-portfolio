...
export default function Presentation() {
  ...
  const pointerEvents = useTransform(
    scrollYProgress,
    (value) => value > 0.15 ? 'none' : 'auto'
  );

  return (
    <section id="presentation" className="min-h-screen flex items-center p-8 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-[320px] overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="absolute bottom-0 left-0 w-full min-w-[1440px] preserve-aspect transform rotate-180" preserveAspectRatio="xMidYMid slice">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="absolute bottom-0 left-0 w-full min-w-[1440px] preserve-aspect transform rotate-180" preserveAspectRatio="xMidYMid slice">
          <path fill="rgb(30 27 75 / 0.5)" d="M0,96L48,128C96,160,192,224,288,250.7C384,277,480,267,576,218.7C672,171,768,85,864,80C960,75,1056,149,1152,186.7C1248,224,1344,224,1392,224L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"/>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="absolute bottom-0 left-0 w-full min-w-[1440px] preserve-aspect transform rotate-180" preserveAspectRatio="xMidYMid slice">
          <path fill="rgb(23 37 84 / 0.5)" d="M0,160L48,133.3C96,107,192,53,288,69.3C384,85,480,171,576,218.7C672,267,768,277,864,250.7C960,224,1056,160,1152,160C1248,160,1344,224,1392,256L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"/>
        </svg>
      </div>
