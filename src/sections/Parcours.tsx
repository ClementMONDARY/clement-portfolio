...
export default function Parcours() {
  return (
    <section id="parcours" className="min-h-screen py-20 overflow-hidden bg-gradient-to-tr from-blue-950/50 via-indigo-950/50 to-purple-950/50 border-t border-gray-700/50">
