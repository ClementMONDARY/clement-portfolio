export const projects = [
  {
    title: "Runner",
    description:
      "Un programme Rust qui utilise la techonlogie de rayscating pour générer un terrain de jeu en 3D (à la Doom/Wolfenstein). Le joueur peut se déplacer dans la carte et changer sa FOV. Si vous voulez l'essayer, il vous suffit de télécharger le fichier exécutable ci-dessous (Z/Q/S/D pour se déplacer, ←/→ pour tourner, A/E pour modifier la FOV, ↓ pour reset la FOV).",
    image: "runner.gif",
  ...
  },
  {
    title: "LoL Website",
    description:
      "Un projet scolaire qui avait pour but de manier une API en ligne. Le sujet etait libre, j'ai donc choisi L'API de League of Legends. Le site permet de consulter les champions, leurs sorts, ainsi que leurs skins. Il est responsive et utilise une API pour récupérer les données des champions.",
  ...
  },
  {
    ...
    description:
      "Un site vitrine pour la marque de bijoux \"Trésor\" dans le cadre de mon stage effectué chez THOM Group avec l'aide de l'équipe de développement. Le site est responsive, et propose une carte interactive pour localiser les magasins de la marque",
    image: "tresor.gif",
  ...
  },
  {
    title: "Windraw",
    description:
      "Une fênetre qui permet de dessiner des pixels sur un canvas, commes des lignes, des cercles et des spirales. Il s'agit d'un projet qui m'as permit de manier les pixels d'un écran ainsi que de découvrir la gestion de la mémoire et de la pile.",
    image: "windraw.gif",
